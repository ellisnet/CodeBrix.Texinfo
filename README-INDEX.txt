...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Texinfo2Html.MitLicenseForever — GNU Texinfo (.texi / .tely)
      source to HTML and CSS written for PDF generation; no dependencies.
  src/CodeBrix.Texinfo2Pdf/AGENT-README.txt
      CodeBrix.Texinfo2Pdf.MitLicenseForever — GNU Texinfo source to a finished
      PDF in one call, built on Texinfo2Html plus CodeBrix.PdfDocCreate.Html2Pdf.
